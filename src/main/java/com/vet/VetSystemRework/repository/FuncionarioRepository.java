...
public interface FuncionarioRepository extends JpaRepository<Funcionario, Long>{
	...
	@Query("select f from Funcionario f where exists(" 
	+ "select c from CargaHoraria c where f.nome = c.funcionario.nome and c.inicio <= :start and c.fim >= :end and c.diaDaSemana between :diaInicial and :diaFinal" + ") " 
